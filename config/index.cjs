...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      openUrl: 'https://site.douban.com/hzsapa/room/1260346/',
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
        ...
        contents: [
          '既然这个公众号你还有在观看，我信守承诺保持更新。之前你说很想帮助猫猫，比如上门喂食陪玩之类的，我找到了个组织，可以点击此页面查询详细信息，之前想当面跟你说来着，有意请电联18050120279.最近杭州甲流等流感频发，甲流的典型症状是发烧与全身肌肉酸痛，切忌与新冠搞混，如需送药上门+照顾服务，请拨打18050120279.'
        ]},
  ],
    // 你可以不断按格式往下增加
    // ...
