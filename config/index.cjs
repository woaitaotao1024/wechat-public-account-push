...
const USER_CONFIG = {
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
        ...
        contents: [
          '周日：今天终于没失眠，不过昨晚上脑子里为什么老是有一串数字和一个人在哭啊。算了不想了，叫室友起床吃早餐去。吃完早餐继续睡，那个人和那串数字又出现了，醒来一直想不起来做的什么梦。晚上出门跟室友出去搓一顿耶，走在路上突然拿出手机输入那一串数字，原来是他在手机删了她的手机号，但却永远记在了他脑袋里，那我又是谁呢？'
        ]},
  ],
    // 你可以不断按格式往下增加
    // ...
