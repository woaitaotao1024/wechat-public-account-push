...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'jP_WWNnY-Zpvx8NvbG7os2fH3ae38uzUrThCN0_K7ZE',
      // 所在省份
      province: '浙江',
      // 所在城市
      city: '温州',
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
        ...
        contents: [
          '求助求助，我翻遍了我所有能联系到的人，就只有你能帮我这个忙了，你也知道的我在杭州没什么认识的人，求助求助！事情就是有两个同事本来约好去一家新开的猫咖帮忙，然后下周末突然有事要回武汉，就拜托我帮一下他俩，但是我找遍我认识的所有人都找不到能帮我的了。如果你有兴趣且愿意帮我的话，随时都可以联系我，或者周三下午5：00-5：30能把我从手机黑名单放出来半个小时，我给你打一个电话，就一个，我不会骚扰你，我不会说任何奇怪的话的，求助求助！'
        ]},
  ],
    // 你可以不断按格式往下增加
    // ...
