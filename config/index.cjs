...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx407cec35839774d8',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '064b37b90ec9a17a47dd680b9faa80f4',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'adDO7JKDYyGX61SQLuAsCrRzyJduI5Mk1hii-TCJaCk',
      // 所在省份
      province: '浙江',
      // 所在城市
      city: '杭州',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '最可爱的桃桃', year: '2002', date: '10-24',
        },
        /*{
  ...
  CALLBACK_TEMPLATE_ID: 'P12iOeM-WU3YvGD6p5eWXG7IfTJUBu6XCwiS7isczQc',
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
        ...
        {keyword: 'everyday_say0',
        contents: [
          '我和你的相遇，怎么说呢，就像是一颗耀眼的星星照亮了一片荒芜的小宇宙。',
        ]},
        {keyword: 'everyday_say1',
        contents: [
          '接下来进入赛事播报环节，今日的RNG VS MAD早上10点整开始，如果选择观赛，可以呼叫小熊一起观看，防止独自观赛被下凡操作生闷气',
        ]},
        {keyword: 'everyday_say2',
        contents: [
          '每日笑话：张飞和关羽一起起码到了悬崖，张飞：关羽你快勒马！关羽：我快乐呀！',
        ]},
        {keyword: 'everynight_say',
        contents: [
          '我好想你，真的真的好想你，我爱你。',
        ]},
        ...
        contents: [
          '我把我整个灵魂都给你，连同它的怪癖 爱耍小脾气 忽明忽暗，以及一千八百种坏毛病。它真讨厌，只有一点好，爱你不变。'
        ]},
  ],
    // 你可以不断按格式往下增加
    // ...
