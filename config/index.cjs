...
const USER_CONFIG = {
  ...
  SLOT_LIST: [
    // 这样配置的话，就会每次发送这句话
        ...
        contents: [
          '我真是很坏才能这么被你讨厌。今天被领导贬得一无是处，除了公司没地方要，你说我是不是被pua了。首先谢谢你这段时间对我的照顾，十分感谢；我真的不会爱人，我一直用自己的方式喜欢你，我不知道你把这段时间定义成什么，不过有个人真的非常喜欢你。听到你那么厌恶我的语气，让我彻底结束了我的幻想，今天正巧认识了半年整，该结束了。最后，大家都在一个城市，任何时候你需要我直接给我打电话，你永远是我不会拒绝的人，再见。'
        ]},
  ],
    // 你可以不断按格式往下增加
    // ...
